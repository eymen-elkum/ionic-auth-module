...
angular.module('ionicAuth').service('Encryptor', function (authSetting) {
    ...
    var fnCipher = function (str) {
        return CryptoJS.TripleDES.encrypt(str, authSetting.encryption_key).toString();
    }
    var fnDeCipher = function (str) {
        return CryptoJS.TripleDES.decrypt(str, authSetting.encryption_key).toString(CryptoJS.enc.Utf8);
    }
    // Public Service APIs
    return {
        cipher  : fnCipher,
